    ...
    <header class="d-print-none">
      <div class="container text-center text-lg-left">
        <div class="py-3 clearfix">
          <h1 class="site-title mb-0">Haris Khurshid</h1>
          <div class="site-nav">
            <nav role="navigation">
...
<div class="cover shadow-lg bg-white">
  <div class="cover-bg p-3 p-lg-4 text-white">
    <div class="row">
      <div class="col-lg-4 col-md-5">
        <div class="avatar hover-effect bg-white shadow-sm p-1"><img src="images/winter.jpg" width="200" height="200"/></div>
      </div>
      <div class="col-lg-8 col-md-7 text-center text-md-start">
        <h2 class="h1 mt-2" data-aos="fade-left" data-aos-delay="0">Haris Khurshid</h2>
        <p data-aos="fade-left" data-aos-delay="100">PHP & Laravel developer</p>
  ...
  <div class="about-section pt-4 px-3 px-lg-4 mt-1">
    <div class="row">
      <div class="col-md-6">
        ...
        <p>Self-motivated and enthusiastic 
          worker with experience in many 
          different fields. Bringing forth a 
          proven track record of 
          achievement and a reputation for 
          positive collaboration. Confident,
          hardworking, and committed to 
          seeing results in whatever position 
          I am in. Reliable and dedicated to 
          finding a place that will benefit 
          from my skill set and energetic 
          drive.</p>
      </div>
      <div class="col-md-5 offset-md-1">
        <div class="row mt-2">
          ...
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">hkhurshid95@gmail.com</div>
          </div>
          <div class="col-sm-4">
            <div class="pb-1">Phone</div>
          </div>
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">+923328681588</div>
          </div>
          <div class="col-sm-4">
            <div class="pb-1">Address</div>
          </div>
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">Pak Arab Housing scheme,Lahore,Pakistan </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="mb-2"><span>SQL</span>
          <div class="progress my-1">
            <div class="progress-bar bg-primary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        ...
        <div class="mb-2"><span>Postman</span>
          <div class="progress my-1">
            <div class="progress-bar bg-primary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        ...
        <div class="mb-2"><span>Node.js</span>
          <div class="progress my-1">
            <div class="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right" data-aos-delay="500" data-aos-anchor=".skills-section" style="width: 70%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        <div class="mb-2"><span>DSA</span>
          <div class="progress my-1">
        ...
        <div class="mb-2"><span>MongoDB</span>
          <div class="progress my-1">
            <div class="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right" data-aos-delay="600" data-aos-anchor=".skills-section" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        <div class="mb-2"><span>MS Office</span>
          <div class="progress my-1">
            <div class="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right" data-aos-delay="600" data-aos-anchor=".skills-section" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
  ...
  <div class="work-experience-section px-3 px-lg-4">
    ...
    <div class="timeline">
      <div class="timeline-card timeline-card-primary card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">DIRECT SERVICE PROVIDERS, LAHORE, PAKISTAN
            <span class="text-muted h6">at Software Agency</span></div>
          <div class="text-muted text-small mb-2">JAN 2021-MAY 2021 </div>
          <div>Present Direct Service provider is the company that provides the 
            services such as web application development (front-end and 
            back-end developer) in Laravel, PHP, and WordPress. I get to 
            have many experiences in this project and am excited to work on 
            further projects.</div>
        </div>
      </div>
      <div class="timeline-card timeline-card-primary card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">PROGRAMMER FORCE, LAHORE, PAKISTAN <span class="text-muted h6">at Software Studio</span></div>
          <div class="text-muted text-small mb-2">OCT 11-DEC 21
          </div>
          <div>Programmer’s force is a well IT solution. I joined this IT solution 
            to increase and enhance my skills.
            </div>
        </div>
      </div>
    </div>
  ...
  <div class="education-section px-3 px-lg-4 pb-4">
    ...
    <div class="timeline">
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Information Computer Science <span class="text-muted h6">from Govt.Khawaja Rafique Shaheed College</span></div>
          <div class="text-muted text-small mb-2">2014 - 2016</div>
      ...
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Bachelor of Computer Science <span class="text-muted h6">from Bahria University</span></div>
  ...
  <div class="education-section px-3 px-lg-4 pb-4">
    ...
    <div class="timeline">
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Distributer Management 

             <!-- <span class="text-muted h6">from International University</span> -->
            </div>
          <!-- <div class="text-muted text-small mb-2">2011 - 2013</div> -->
          <div><a href="http://retailact.pk">retailact</a></div>
          <div>             
            Developed ERP System to manage daily stock, inventory, and 
            orders. Developed Rest APIs for mobile applications.</div>
        </div>
      </div>
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">E-Healthcare (An online consultant and medical prescription) 
             
            <!-- <span class="text-muted h6">from Regional College</span> -->
          </div>
          <!-- <div class="text-muted text-small mb-2">2007 - 2011</div> -->
          <div>An online healthcare platform where a patient can chat with their 
            respective doctors and share information.</div>
        </div>
      </div>
      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Image-hosting 
 
            <!-- <span class="text-muted h6">from Mt. High Scool</span> -->
          </div>
          <!-- <div class="text-muted text-small mb-2">1995 - 2007</div> -->
          <div>            Creating restful APIs for image hosting with JWT authentication 
            for the front end. And deploy them on Heroku.</div>
        </div>
      </div>

      <div class="timeline-card timeline-card-success card shadow-sm">
        <div class="card-body">
          <div class="h5 mb-1">Social-App 
            
 
            <!-- <span class="text-muted h6">from Mt. High Scool</span> -->
          </div>
          <!-- <div class="text-muted text-small mb-2">1995 - 2007</div> -->
          <div>Creating restful API for adding friends and making chats among 
            them.</div>
        </div>
      </div>
    </div>
...
<form>
      ...
      <input id="submit" type="button" class="btn btn-primary mt-2" value="Submit" />
      ...
      <div class="col">
        <div class="mt-2">
          ...
          <div class="pb-2 text-secondary">Pak Arab Housing scheme,Lahore,Pakistan
          </div>
          <h3 class="h6">Phone</h3>
          <div class="pb-2 text-secondary">+923328681588</div>
          <h3 class="h6">Email</h3>
          <div class="pb-2 text-secondary">hkhurshid95@gmail.com</div>
        </div>
      </div>
    ...
    <footer class="pt-4 pb-4 text-muted text-center d-print-none">
      <div class="container">
        <div class="my-3">
          <div class="h4">Haris Khurshid</div>
        </div>
